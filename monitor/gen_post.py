...
class GenPosts(object):
    ...
    def LowPowerGeneration(self, strPVName, strStartTime, strEndTime, intTotal, intTargetTotal, intTargetPercent):
        dicNotify = {
            ...
            "icon": "https://%s/postpicture/SolarPanel.png" % self.strHost,
            ...
            "images": [
                    {
                        "previewImageUrl": "https://%s/postpicture/post_LowSellingPower.png" % self.strHost,
                        "originalContentUrl": "https://%s/postpicture/post_LowSellingPower.png" % self.strHost
                    }
                ],
            "contents": []
        }
    ...
    def NoPowerGeneration(self, strPVName, strMin):
        dicNotify = {
            ...
            "images": [
                    {
                        "previewImageUrl": "https://%s/postpicture/post_NoPower.png" % self.strHost,
                        "originalContentUrl": "https://%s/postpicture/post_NoPower.png" % self.strHost
                    }
                ],
            "contents": []
        }
